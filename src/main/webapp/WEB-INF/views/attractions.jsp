			...
			<div class="span3">
				<div class="sidebar-nav">
					<ul class="nav nav-list">
						...
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=attractions&query=popular+art+gallery+city+hall+in+${citynm}&types=art_gallery|city_hall">Art
								Gallery</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=museum&query=popular+museum+in+${citynm}">Museum</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=theater&query=top+rated+movie+theater+in+${citynm}">Movie
								Theater</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=attractions&query=top+rated+zoo+and+aquarium+in+${citynm}&types=zoo|aquarium">Zoo,
								Sea life & Aquarium</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=attractions&query=top+rated+amusement+park+in+${citynm}&types=amusement_park">Amusement
								Park</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=church&query=church+in+${citynm}&types=church">Church</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=mosque&query=mosque+in+${citynm}&types=mosque">Mosque</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=temple&query=temple+in+${citynm}&types=hindu_temple">Temple</a></li>
						<li class="nav-header">Shopping</li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=mall&query=popular+shopping+mall+in+${citynm}&types=shopping_mall">Popular
								Shopping Mall</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=jewellery&query=top+rated+jewelry+store+in+${citynm}&types=jewelry_store">Jewellery
								Store</a></li>
						<li><a
							href="/Travelify/travelicity/guide/attractions/${citynm}?cat=market&query=nearby+grocery+supermarket+in+${citynm}&types=grocery_or_supermarket">Super
								Market</a></li>
			...
			$
					...
					.done(
							function() {
								$('#clipmodal')
										.html(
												'_$taThis place is successfully clipped to your clipp list... It is available in My Clips_$tag_$tag_______________________________________________________Close_$tag____');
					...
					.fail(
							function() {
								$('#clipmodal')
										.html(
												'_$taSomething went wrong... pls try again later..._$tag_$tag_______________________________________________________Close_$tag____');
								$('#clipmodal').modal('show');
							});
