			...
			<div class="span3">
				<div class="sidebar-nav">
					<ul class="nav nav-list">
						...
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=top+rated+restaurants+in+${citynm}">Top
								Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+breakfast+restaurants+in+${citynm}">Popular
								Breakfast Joints</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+american+restaurants+in+${citynm}">Popular
								American Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+indian+restaurants+in+${citynm}">Popular
								Indian Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+asian+restaurants+in+${citynm}">Popular
								Asian Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+mexican+restaurants+in+${citynm}">Popular
								Mexican Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+italian+restaurants+in+${citynm}">Popular
								Italian Restaurants</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=restaurant&query=popular+seafood+restaurants+in+${citynm}">Popular
								Sea Food Joints</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=cafe&query=popular+cafe+in+${citynm}">Popular
								Cafe</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=bar&query=popular+bar+in+${citynm}">Popular
								Bar</a></li>
						<li><a
							href="/Travelify/travelicity/guide/eating/${citynm}?cat=nightclub&query=popular+night+club+in+${citynm}">Popular
								Night Club</a></li>
